...
class cls_phpmailer
{
     ...
     *
     * @see clsphpmailer::$Username
     * @see clsphpmailer::$Password
     *
     * @var bool
     */
     ...
     *
     * @see clsphpmailer::validateAddress()
     *
     * @var string|callable
     */
     ...
     * @see clsphpmailer::$cc
     * @see clsphpmailer::$bcc
     * @see clsphpmailer::$all_recipients
     *
     * @var array
     */
     ...
     *
     * @param string $str
     *@see clsphpmailer::$SMTPDebug
     *
     * @see clsphpmailer::$Debugoutput
     */
     ...
     *@throws Exception
     *
     * @see clsphpmailer::setSMTPInstance() to use a different class.
     *
